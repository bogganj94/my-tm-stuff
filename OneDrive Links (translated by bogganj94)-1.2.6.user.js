// ==UserScript==
// @name         OneDrive Links (translated by bogganj94)
// @namespace    http://tampermonkey.net/
// @version      1.2.6
// @description  获得 OneDrive 文件Download直链的 TamperMonkey 插件
// @author       KAAAsS
// @license      MIT
...
// @connect      *
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/432415/OneDrive%20%E6%96%87%E4%BB%B6%E4%B8%8B%E8%BD%BD%E7%9B%B4%E9%93%BE.user.js
// @updateURL https://update.greasyfork.org/scripts/432415/OneDrive%20%E6%96%87%E4%BB%B6%E4%B8%8B%E8%BD%BD%E7%9B%B4%E9%93%BE.meta.js
// ==/UserScript==
...
const AppName = "OneDrive Links (translated by bogganj94)"
    ...
    [
      _c("el-scrollbar", [
          ...
          [
              ...
              [
                ...
                _c(
                  "el-tooltip",
                  {
                    ...
                    attrs: {
                      effect: "dark",
                      content: "Not very easy to use. It is recommended to use IDM or Aria push first.",
                      placement: "top-start"
                    }
                  },
                  [
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "filename", label: "file name" }
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { label: "operate" },
        ...
        _c("div", { staticClass: "sub-container" }, [
          _c("h3", { staticClass: "sub-title" }, [_vm._v("Cookie Information")]),
          _vm._v(" "),
          this.cookie === ""
            ? _c(
                "div",
                ...
                [
                  _c("el-alert", {
                    attrs: {
                      title: "Unable to obtain cookie information",
                      type: "info",
                      description:
                        "Since you are not using Tampermonkey Beta, you cannot automatically obtain cookies. Please go to 'Developer Options-Application-Cookie' and copy the value corresponding to FedAuth. Then, fill in 'Custom Request Headers' in AriaNG with: Cookie: FedAuth=copied value",
                      "show-icon": "",
                      closable: false
                    }
                  })
                ...
                [
                  _c("el-alert", {
                    ...
                    attrs: {
                      title: "Cookie 信息",
                      type: "success",
                      description: "Download时在 AriaNG 的“自定义请求头”填写",
                      "show-icon": "",
                      closable: false
                    }
                  }),
        ...
        _vm._v(" "),
        _c("div", { staticClass: "sub-container" }, [
          _c("h3", { staticClass: "sub-title" }, [_vm._v("Set Up")]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "btn-group-files" },
        ...
        if (isDev) {
            ...
            return await new Promise(function (resolve, reject) {
                GM_xmlhttpRequest({
                    ...
                    onload(res) {
                        if (res.status === 200) {
                            if (res.response.result) {
                                ...
                                // 其它错误
                                reject(`Download错误！${res.response.message}`);
                            }
                        } else {
                    ...
                    onerror(res) {
                        reject("无法发送 Aria Download请求！请尝试添加服务器路径到用户域名白名单。");
                        console.error("无法发送 Aria Download请求！", res);
                    }
                });
            });
        }
...
/* harmony default export */ const PluginPanelvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleCopyFile() {
      ...
      if (links.length < 1) {
        this.$message.error("请选择要Download的文件！");
        return;
      }
    ...
    handleIdm() {
      ...
      this.$message.success("成功！请在 IDM 中导入此文件Download");
    },
    handleAria() {
